...
Forecast Weather sur Mac propose une liste d’options en haut de la carte.

![]({{ site.baseurl }}/assets/images/Detailexercice-boutonMac.png)

- ![alt text]({{ site.baseurl }}/assets/images/icon/cloud.sun.png) Calcul des prévisions météo
- ![alt text]({{ site.baseurl }}/assets/images/icon/chart-icon.png) Prévisions météo sous forme graphique
- ![alt text]({{ site.baseurl }}/assets/images/icon/map.png) Carte en mode standard ou satellite
